...
| Entry | Highlights |
|-------|-----------|
| [2026-06-22](changelog/2026-06-22.md) | Multi-node Raft over the fabric; cluster formation from seeds; split-brain mitigation; package-update handler + security-update warnings + OSV vulnerability scanning |
